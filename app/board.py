...
class Board:
	...
	def __init__(self, rows: int = config.BOARD_ROWS,
				 columns: int = config.BOARD_COLUMNS,
				 empty_loc_symbol: str = "[  ]"):
		# TODO - rename rows to row_amount and columns to columns_amount
		# TODO - remove the empty_loc_symbol since default params shouldn't be mutable
